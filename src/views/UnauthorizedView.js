...
class UnauthorizedView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6164a6e4647447eb9d242a87'
          ...
          <div>
            <div className="af-class-utility-page-wrap">
              <div className="af-class-utility-page-content w-password-page w-form">
                <form action="/.wf_auth" method="post" className="af-class-utility-page-form w-password-page"><img src="https://d3e54v103j8qbb.cloudfront.net/static/utility-lock.ae54711958.svg" alt />
                  <h2>Protected Page</h2><label htmlFor="pass">Password</label><input type="password" autofocus="true" id="pass" name="pass" placeholder="Enter your password" maxLength={256} className="w-password-page w-input" /><input type="submit" defaultValue="Submit" data-wait="Please wait..." className="w-password-page w-button" />
